...
import type {
  SimpleEscrow,
  SimpleEscrowInterface,
} from "../../contracts/SimpleEscrow";
...
type SimpleEscrowConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: SimpleEscrowConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class SimpleEscrow__factory extends ContractFactory {
  constructor(...args: SimpleEscrowConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): SimpleEscrow__factory {
    return super.connect(runner) as SimpleEscrow__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SimpleEscrowInterface {
    return new Interface(_abi) as SimpleEscrowInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SimpleEscrow {
    return new Contract(address, _abi, runner) as unknown as SimpleEscrow;
  }
}
